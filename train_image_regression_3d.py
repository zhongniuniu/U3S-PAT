...
for it, (grid, image) in enumerate(data_loader):
    ...
    save_image_3d(test_data[1], slice_idx, os.path.join(image_directory, "test.jpg"))
    save_image_3d(train_data[1], slice_idx, os.path.join(image_directory, "train.jpg"))
    ...
    for iterations in range(max_iter):
        ...
        train_embedding = encoder.embedding(train_data[0])  # [B, C, H, W, embedding*2] fuliyebianhuan
